            ...
            <section className="flex flex-col lg:flex-row bg-blue-950">
                ...
                <div className="w-full lg:max-w-96 p-8">
                    <div className="pb-4">              
                        ...
                        <p>
                            Desenvolvido pelos docentes da Escola Estadual Dom Barreto,
                            a plataforma visa facilitar o acesso dos estudantes às
                            informações relacionadas a vestibulares, cursos técnicos,
                            cursinhos populares, eventos, entre outros.
                        </p>
                    </div> 
                </div>              
            </section>
